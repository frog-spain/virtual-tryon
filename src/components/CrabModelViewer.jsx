      ...
      >
        {isAnnotationsOn && (
          <>
            ...
            >
              <div className="HotspotAnnotation">Eye</div>
            </div>
            <div
              className="hotspot"
              slot="hotspot-2"
              ...
              data-visibility-attribute="visible"
            >
              <div className="HotspotAnnotation">Claw</div>
            </div>
            <div
              className="hotspot"
              slot="hotspot-3"
              ...
              data-visibility-attribute="visible"
            >
              <div className="HotspotAnnotation">Dactyle</div>
            </div>
            <div
              className="hotspot"
              slot="hotspot-4"
              ...
              data-visibility-attribute="visible"
            >
              <div className="HotspotAnnotation">Swimming leg</div>
            </div>
            <div
              className="hotspot"
              slot="hotspot-7"
              ...
              data-visibility-attribute="visible"
            >
              <div className="HotspotAnnotation">Walking leg</div>
            </div>
